...
public class EdgeXReleaseDockerImageIntSpec extends JenkinsPipelineSpecification {
    ...
    def "Test edgeXReleaseDockerImage [Should] run echo commands to tag and push when DRY_RUN is true [When] called" () {
        ...
        then:
            ...
            1 * getPipelineMock('echo').call([
                    'docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main',
                    'docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go:v1.2.0',
                    'docker push nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go:v1.2.0'
                ].join("\n"))

            1 * getPipelineMock('echo').call([
                    'docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main',
                    'docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main docker.io/edgexfoundry/docker-app-functions-sdk-go:v1.2.0',
                    'docker push docker.io/edgexfoundry/docker-app-functions-sdk-go:v1.2.0'
                ].join('\n'))

            1 * getPipelineMock('echo').call([
                    'docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main',
                    'docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go-arm64:v1.2.0',
                    'docker push nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go-arm64:v1.2.0'
                ].join("\n"))

            1 * getPipelineMock('echo').call([
                    'docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main',
                    'docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main docker.io/edgexfoundry/docker-app-functions-sdk-go-arm64:v1.2.0',
    ...
    def "Test edgeXReleaseDockerImage [Should] run echo commands to tag and push when DRY_RUN_PULL_DOCKER_IMAGES is true [When] called" () {
        ...
        then:
            ...
            2 * getPipelineMock('sh').call("docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main")
            ...
            2 * getPipelineMock('sh').call("docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main")
    ...
    def "Test edgeXReleaseDockerImage [Should] run sh commands to tag and push when DRY_RUN is false [When] called" () {
        ...
        then:
            ...
            1 * getPipelineMock('sh').call("docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go:v1.2.0")
            1 * getPipelineMock('sh').call("docker push nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go:v1.2.0")
            1 * getPipelineMock('sh').call("docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main docker.io/edgexfoundry/docker-app-functions-sdk-go:v1.2.0")
            1 * getPipelineMock('sh').call("docker push docker.io/edgexfoundry/docker-app-functions-sdk-go:v1.2.0")

            2 * getPipelineMock('sh').call("docker pull nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main")

            1 * getPipelineMock('sh').call("docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go-arm64:v1.2.0")
            1 * getPipelineMock('sh').call("docker push nexus3.edgexfoundry.org:10002/docker-app-functions-sdk-go-arm64:v1.2.0")
            1 * getPipelineMock('sh').call("docker tag nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go-arm64:main docker.io/edgexfoundry/docker-app-functions-sdk-go-arm64:v1.2.0")
    ...
    def "Test edgeXReleaseDockerImage [Should] error [When] invalid yaml configuration is used" () {
        ...
        then:
            1 * getPipelineMock('echo').call("[edgeXReleaseDockerImage] The sourceImage [nexus3.edgexfoundry.org:10004/docker-app-functions-sdk-go:main] did not release...")
    }
