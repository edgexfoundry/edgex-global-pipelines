...
'''])
    ...
    def "Test multiArch [Should] retag and create image manifest [When] called with nexus image" () {
        when:
            edgeXDocker.multiArch('nexus3.edgexfoundry.org:10004/device-mock:latest')
        then:
            1 * getPipelineMock('sh').call('docker pull nexus3.edgexfoundry.org:10004/device-mock:latest')
            1 * getPipelineMock('sh').call('docker pull nexus3.edgexfoundry.org:10004/device-mock-arm64:latest')
            1 * getPipelineMock('sh').call('docker tag nexus3.edgexfoundry.org:10004/device-mock:latest nexus3.edgexfoundry.org:10004/device-mock-amd64:latest && docker rmi -f nexus3.edgexfoundry.org:10004/device-mock:latest')
            1 * getPipelineMock('sh').call('docker push nexus3.edgexfoundry.org:10004/device-mock-amd64:latest')
            1 * getPipelineMock('sh').call('docker manifest create nexus3.edgexfoundry.org:10004/device-mock:latest --amend nexus3.edgexfoundry.org:10004/device-mock-amd64:latest --amend nexus3.edgexfoundry.org:10004/device-mock-arm64:latest')
    }

    def "Test multiArch [Should] retag and create image manifest [When] called with non-nexus image" () {
        when:
            edgeXDocker.multiArch('edgexfoundry/device-mock:latest')
        then:
            0 * getPipelineMock('sh').call('docker pull edgexfoundry/device-mock:latest')
            0 * getPipelineMock('sh').call('docker pull edgexfoundry/device-mock-arm64:latest')
            1 * getPipelineMock('sh').call('docker tag edgexfoundry/device-mock:latest edgexfoundry/device-mock-amd64:latest && docker rmi -f edgexfoundry/device-mock:latest')
            1 * getPipelineMock('sh').call('docker push edgexfoundry/device-mock-amd64:latest')
            1 * getPipelineMock('sh').call('docker manifest create edgexfoundry/device-mock:latest --amend edgexfoundry/device-mock-amd64:latest --amend edgexfoundry/device-mock-arm64:latest')
    }
}
